...
const VascularDiseaseSectionAccordion = ({ name }: { name: string }) => {
          ...
          <div className='card-body'>
            ...
            <div className="mb-3">
              ...
              {/* <TinyMCEEditorField 
                ...
                editorId={'accordion_VascularDisease_description_'+index}
                register={register}
                setValue={setValue} /> */}
            </div>
...
export default VascularDiseaseSectionAccordion;