...
import { getPageById, updatePage } from '@/utils/pages';
...
export default function EditPage() {
    ...
    useEffect(() => {
        const fetchPageData = async () =>{
            try {
                setLoading(true)
                const pageResponse = await getPageById(id)
    ...
    const handleSubmit = async (formData: Partial<any>) => {
        try {
            ...
            const updatedPageResponse = await getPageById(id)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3"> Edit Page: {page?.title}</h1>
              </div>
