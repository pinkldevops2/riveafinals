...
import { getCSType, deleteCSType } from '@/utils/caseStudyType';
...
export default function CaseStudyType() {
    ...
    const handleDelete = async (id: string) => {
        try {
            const res = await deleteCSType(id);
            if(res.success == false){
                toast.error(res.error);
            }else{
                toast.success("Case Study Type deleted successfully.");
    ...
    const fetchData = async (pageNumber = 1, perPageSize = 10, sortCol = "_id", sortOrd = "asc", search = '') => {
        //setLoading(true);
        try {
            getCSType(search, pageNumber, perPageSize, sortCol, sortOrd).then(result => {
                if (result.data) {
                    setData(result.data);
      ...
      const handleSearch = (event: any) => {
        ...
        const columns = [
            ...
            cell: (row: any) => (
                <>
                <Link className="btn text-primary" href={"/admin/case-study-type/"+row._id}>
                    <i className='fa fas fa-pen'></i>
                </Link>
                <ConfirmDeleteModal id={row._id} onDelete={handleDelete} msg="Are you sure you want to delete this case-study-type?" />
                </>
            ),
            },
        ];
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">Case Study Type</h1>
                  <div className="">
              ...
              <div className="row">
                  ...
                  <div className="card shadow mb-4">
                        <div className="card-header py-3 d-flex justify-content-between">
                            <h6 className="m-0 font-weight-bold text-primary">Case Study Type</h6>
                            <Link className='btn btn-dark btn-sm' href={'/admin/case-study-type/add'}><i className='fa fa-plus'></i> Add New Case Study Type</Link>
                        </div>
