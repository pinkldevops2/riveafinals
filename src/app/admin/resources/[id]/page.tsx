...
import { getResourcesById, updateResource } from '@/utils/resources';
...
export default function EditResource() {
    ...
    useEffect(() => {
        const fetchPageData = async () =>{
            try {
                setLoading(true)
                const pageResponse = await getResourcesById(id)
    ...
    const handleSubmit = async (formData: Partial<any>) => {
        try {
            ...
            const updatedPageResponse = await getResourcesById(id)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3"> Edit Resource: {page?.name}</h1>
              </div>
