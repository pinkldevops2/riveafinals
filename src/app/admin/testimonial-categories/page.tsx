...
import { getCategories, deleteCategory } from '@/utils/testimonialCategories';
    ...
    const fetchData = async (pageNumber = 1, perPageSize = 10, sortCol = "_id", sortOrd = "asc", search = "") => {
      ...
      const handleSearch = (event: any) => {
        ...
        const columns = [
            ...
            cell: (row: any) => (
                <>
                <Link className="btn text-primary" href={"/admin/testimonial-categories/"+row._id}>
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">Testimonial Categories</h1>
                  <div className="">
              ...
              <div className="row">
                  ...
                  <div className="card shadow mb-4">
                        <div className="card-header py-3 d-flex justify-content-between">
                            <h6 className="m-0 font-weight-bold text-primary">Testimonial Categories</h6>
                            <Link className='btn btn-dark btn-sm' href={'/admin/testimonial-categories/add'}><i className='fa fa-plus'></i> Add New Category</Link>
                        </div>
