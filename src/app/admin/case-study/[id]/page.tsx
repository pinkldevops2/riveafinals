...
import { getCaseStudyById, updateCaseStudy } from '@/utils/caseStudy';
...
export default function EditCaseStudy() {
    ...
    useEffect(() => {
        const fetchPageData = async () =>{
            try {
                setLoading(true)
                const pageResponse = await getCaseStudyById(id)
    ...
    const handleSubmit = async (formData: Partial<any>) => {
        try {
            ...
            const updatedPageResponse = await getCaseStudyById(id)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3"> Edit Case Study: {page?.title}</h1>
              </div>
