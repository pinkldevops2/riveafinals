...
import { getTestimonialById, updateTestimonial } from '@/utils/testimonials';
...
export default function EditTestimonial() {
    ...
    useEffect(() => {
        const fetchPageData = async () =>{
            try {
                setLoading(true)
                const pageResponse = await getTestimonialById(id)
    ...
    const handleSubmit = async (formData: Partial<any>) => {
        try {
            ...
            const updatedPageResponse = await getTestimonialById(id)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3"> Edit Testimonial: {page?.title}</h1>
              </div>
