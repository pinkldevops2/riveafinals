...
import { createDoctor } from '@/utils/doctorList';
...
export default function AddDoctor() {
    ...
    const handleSubmit = async (formData: any) => {
        try{
            ...
            await createDoctor(formData).then(data => {
                if (data.error) {
                    toast.error(data.error);
                    setError(data.error || 'Failed to create a doctor')
                } else {
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">Add Doctor</h1>
              </div>
