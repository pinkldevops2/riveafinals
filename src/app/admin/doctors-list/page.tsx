...
import { getDoctorList, deleteDoctorList } from '@/utils/doctorList';
...
export default function DoctorList() {
    ...
    const handleDelete = async (id: string) => {
        try {
            const res = await deleteDoctorList(id);
    ...
    const fetchData = async (pageNumber = 1, perPageSize = 10, sortCol = "_id", sortOrd = "asc", search = '') => {
        //setLoading(true);
        try {
            getDoctorList(search, pageNumber, perPageSize, sortCol, sortOrd).then(result => {
                if (result.data) {
                    setData(result.data);
      ...
      const handleSearch = (event: any) => {
        ...
        const columns = [
            ...
            { name: "Speciality", selector: (row: any) => row.speciality, sortable: true, sortKey: 'speciality' },
            { name: "Degree", selector: (row: any) => row.degree, sortable: true, sortKey: 'degree' },
            ...
            cell: (row: any) => (
                <>
                <Link className="btn text-primary" href={"/admin/doctors-list/"+row._id}>
                    <i className='fa fas fa-pen'></i>
                </Link>
                <ConfirmDeleteModal id={row._id} onDelete={handleDelete} msg="Are you sure you want to delete this doctor?" />
                </>
            ),
            },
        ];
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">Doctors List</h1>
                  <div>
              ...
              <div className="row">
                  ...
                  <div className="card shadow mb-4">
                        <div className="card-header py-3 d-flex justify-content-between">
                            <h6 className="m-0 font-weight-bold text-primary">Doctors List</h6>
                            <Link className='btn btn-dark btn-sm' href={'/admin/doctors-list/add'}><i className='fa fa-plus'></i> Add New Doctor</Link>
                        </div>
