...
import { getDoctorListById, updateDoctor } from '@/utils/doctorList';
...
export default function EditDoctor() {
    ...
    useEffect(() => {
        const fetchPageData = async () =>{
            try {
                setLoading(true)
                const pageResponse = await getDoctorListById(id)
    ...
    const handleSubmit = async (formData: Partial<any>) => {
        try {
            ...
            const updatedPageResponse = await getDoctorListById(id)
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3"> Edit Doctor: {page?.name}</h1>
              </div>
