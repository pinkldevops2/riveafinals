...
export default function AddNews() {
    ...
    const handleSubmit = async (formData: any) => {
        try{
            ...
            setError(null)
            await createNews(formData).then(data => {
                if (data.error) {
                    toast.error(data.error);
                    setError(data.error || 'Failed to create a news')
                } else {
            ...
            toast.error('Failed to create a news');
        } finally {
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              ...
              <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">Add News</h1>
              </div>
