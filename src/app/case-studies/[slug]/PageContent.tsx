...
import {getCaseStudiesBySlug, getSettingsByType} from '@/utils/frontApi';
...
export default function PageContent(currentDateTime: any) {
  ...
  const { slug } = params;
  useEffect(() => {
    getCaseStudiesBySlug(slug).then(data => {
          ...
          <main className={"main-content footer_resources"}>
            ...
            <div className="nav-sec">
              <div className="nav-sec-inner">
                {prevSlug ?  <a href={'/case-studies/'+prevSlug} className="prev-page"><img src="/images/left_arrow.png" /></a> :  <img src="/images/prev-btn.png" />}
                {nextSlug ? <a href={'/case-studies/'+nextSlug} className="next-page disabled"><img src="/images/next-btn.png" /></a> : <img src="/images/disable-right-arrow.png" />}
              </div>
            </div>
          </section>
          </main>
